...
var MetaService = /** @class */ (function () {
    ...
    MetaService.prototype.getSiteGodown = function (site) {
        return this.api.get('meta/Sitegodown/' + site);
    };
    MetaService.prototype.getSiteIssuedby = function (site) {
        return this.api.get('meta/Siteissuedby/' + site);
    };
    ...
    MetaService.prototype.getSiteList = function () {
        return this.api.get('meta/sitelist');
    };
    ...
    MetaService.prototype.getAccountsLedgerName = function (branch) {
        // console.log('Entering into metaservice >>>>>');
        return this.api.get('meta/accountsledgersName' + branch);
    };
