...
module.exports = ".min-height {\n  min-height: 70vh; }\n\n.cell-align {\n  text-align: right; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AccountsLedgerReportComponent = /** @class */ (function () {
    function AccountsLedgerReportComponent(api, meta, formBuilder, reportService, toastr) {
        ...
        this.pagination = { total: 0, currenPage: 1, pageSize: 50, maxSize: 10 };
        this.usertype = this.meta.getSiteFromStorage().role;
        this.site = this.meta.getSiteFromStorage().site;
        this.filterForm = this.formBuilder.group({
            site: [''],
            account_name: [''],
            start_date: [''],
    ...
    AccountsLedgerReportComponent.prototype.ngOnInit = function () {
        var _this = this;
        // console.log('Entering into site Ng on init >>>>>');
        // this.getAccounts();
        this.getSites();
        // this.fetchReport();
        // site value changes
        this.filterForm.get('site').valueChanges.subscribe(function (val) {
            _this.filterForm.controls['account_name'].setValue(null);
            // console.log('Entering into site >>>>>');
            // getting accountName Details from ledger
            _this.meta.getAccountsLedgerName(val).subscribe(function (res) {
                var accountNameList = [];
                res['info'].forEach(function (dim) {
                    accountNameList.push(dim.accountname);
                });
                _this.accounts_option = accountNameList;
            });
        });
    };
    // getSites() {
    ...
    AccountsLedgerReportComponent.prototype.getSites = function () {
        ...
        this.meta.getSites().subscribe(function (res) {
            ...
            if (_this.usertype === 'ADMIN') {
                _this.filterForm.controls['site'].setValue(_this.siteOptions[0].branch_name);
            }
            else {
                _this.filterForm.controls['site'].setValue(_this.site);
            }
        }, function (err) {
            _this.loading = false;
        });
    ...
    //       console.log('AccountsListt >>>>>', this.accounts_option);
    //     });
    // }
    // getAccounts() {
    ...
    AccountsLedgerReportComponent.prototype.resetFilters = function () {
        this.filterForm.get('account_name').setValue('');
        this.filterForm.get('site').setValue('');
        this.filterForm.get('start_date').setValue('');
        this.filterForm.get('end_date').setValue('');
        this.filters = {
            site: '',
...
module.exports = ".cell-align {\n  text-align: right; }\n\n.truck-selection {\n  cursor: pointer;\n  text-decoration: underline; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".cell-align {\n  text-align: right; }\n\n.truck-selection {\n  cursor: pointer;\n  text-decoration: underline; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".mytable {\n  display: block;\n  overflow-x: auto;\n  white-space: nowrap; }\n\n.cell-align {\n  text-align: right; }\n\n.truck-selection {\n  cursor: pointer;\n  text-decoration: underline; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".mg-top-25 {\n  margin-top: 25px;\n  margin-bottom: 10px; }\n\n@media only screen and (max-width: 600px) {\n  .mg-top-25 {\n    margin-top: 0px; }\n  .wrapper-right {\n    text-align: right; } }\n\n.truck-selection {\n  cursor: pointer;\n  text-decoration: underline; }\n\n.cell-align {\n  text-align: right; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
