...
var routes = [
    {
        ...
        children: [
            ...
            { path: 'admin-master/:id/edit', component: _components_edit_admin_master_edit_admin_master_component__WEBPACK_IMPORTED_MODULE_55__["EditAdminMasterComponent"], resolve: { adm_details: _components_adminmaster_reslover__WEBPACK_IMPORTED_MODULE_56__["AdminmasterReslover"] } },
...
var AddAdminMasterComponent = /** @class */ (function () {
    function AddAdminMasterComponent(fb, as, metaService, router) {
        this.fb = fb;
        this.as = as;
        this.metaService = metaService;
        this.router = router;
    ...
    AddAdminMasterComponent.prototype.getOptions = function () {
        var _this = this;
        this.metaService.getSiteList().subscribe(function (trackInfo) {
            _this.site_option = trackInfo['result'];
        });
    };
...
var AddBrokerMasterComponent = /** @class */ (function () {
    ...
    AddBrokerMasterComponent.prototype.save = function () {
        var _this = this;
        console.log('Broker Master Save', this.sdkForm.value);
        this.process = 'saving';
...
var AddSiteDestinationkmsComponent = /** @class */ (function () {
    ...
    AddSiteDestinationkmsComponent.prototype.getSites = function () {
        var _this = this;
        this.loading = true;
        this.metaService.getSites().subscribe(function (res) {
            _this.loading = false;
    ...
    AddSiteDestinationkmsComponent.prototype.getOptions = function () {
        ...
        // });
        this.metaService.getprefdestinationlist().subscribe(function (siteInfo) {
...
var AddSiteProfileComponent = /** @class */ (function () {
    ...
    AddSiteProfileComponent.prototype.getSites = function () {
        var _this = this;
        this.loading = true;
        this.metaService.getSites().subscribe(function (res) {
            _this.loading = false;
...
var AddTruckAverageComponent = /** @class */ (function () {
    ...
    AddTruckAverageComponent.prototype.getSites = function () {
        var _this = this;
        this.loading = true;
        this.metaService.getSites().subscribe(function (res) {
            _this.loading = false;
            _this.siteOptions = res;
            if (_this.usertype === 'ADMIN') {
                _this.taForm.controls['site'].setValue(_this.siteOptions[0].branch_name);
            }
            else {
                _this.taForm.controls['site'].setValue(_this.site_name);
            }
        }, function (err) {
            _this.loading = false;
        });
...
module.exports = "table {\n  overflow-x: scroll;\n  width: 100%;\n  display: block; }\n  table select {\n    width: 150px; }\n  table .vendor {\n    width: 150px; }\n  table .location {\n    width: 150px; }\n  table .price {\n    width: 120px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var EditAdminMasterComponent = /** @class */ (function () {
    function EditAdminMasterComponent(fb, as, router, metaService, aroute) {
        this.fb = fb;
        this.as = as;
        this.router = router;
        this.metaService = metaService;
...
module.exports = ".table-overflow {\n  overflow: scroll; }\n\n.mg-top-20 {\n  margin-top: 27px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".inputfile {\n  width: 0.1px;\n  height: 0.1px;\n  opacity: 0;\n  overflow: hidden;\n  position: absolute;\n  z-index: -1; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".inputfile {\n  width: 0.1px;\n  height: 0.1px;\n  opacity: 0;\n  overflow: hidden;\n  position: absolute;\n  z-index: -1; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ListSiteDestinationkmsComponent = /** @class */ (function () {
    function ListSiteDestinationkmsComponent(router, meta, as) {
        this.router = router;
        this.meta = meta;
        this.as = as;
...
module.exports = ".scroll-h-page {\n  overflow: scroll; }\n\n::ng-deep .my-class .modal-dialog {\n  max-width: 80%;\n  width: 80%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".scroll-h-page {\n  overflow: scroll; }\n\n::ng-deep .my-class .modal-dialog {\n  max-width: 80%;\n  width: 80%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = ".inputfile {\n  width: 0.1px;\n  height: 0.1px;\n  opacity: 0;\n  overflow: hidden;\n  position: absolute;\n  z-index: -1; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
