...
router.get('/Sitegodown/:site', function(req, res) {
    Single.find({site: req.params.site, field: "Godown"}).sort({name:1}).then( function(result) {
...
router.get('/accountsledgersName/:branch', function(req, res, next) {
    AccountsLedgers.find({branch: req.params.site}).then( function(result) {
        res.send({info: result});
    }).catch (function(err) {
        //console.log("err   >>>>",err);
        res.send(err);
...
router.get('/Siteissuedby/:site', function(req, res) {
    Single.find({site: req.params.site, field: "Issued By"}).sort({name:1}).then( function(result) {
        res.send({info: result});
    }).catch (function(err) {
        res.send(err);
    });
...
router.get('/sitelist', function(req, res, next) {
    ...
    Single.find({field: "Site"}).sort({name:1}).then( function(result) {
        res.send({"result": result});
    }).catch (function(err) {
        //console.log("err   >>>>",err);
        res.send(err);
...
router.get('/issuedbylist', function(req, res, next) {
    Single.find({field: "Issued By"}).sort({name:1}).then( function(result) {
        res.send({"result": result});
    }).catch (function(err) {
        res.send(err);
    });
