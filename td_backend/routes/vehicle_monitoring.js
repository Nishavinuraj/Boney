    ...
    Billty.find(matchCondition).skip(offset).limit(limit).then(function (result) {
        ...
        result.forEach(r => {
            var obj = {
                ...
                "Party_Adv": r.padvance ? r.padvance : 0,               //r.padvance,
                "ex_diesal": Number(r.damount.toFixed(2)) + Number(r.totaltruckexpences.toFixed(2)),
                "comm": (r.newamount - r.vamount ).toFixed(2),
