...
router.get('/ledger', function(req, res, next) {
    ...
    var calculateOpeningBalanceUsingOldRecords = function (defaultOpeningBalance, defaultAccountType, cb) {
        ...
        // console.log(" Fourth Result Old Records matchcond  >>>", matchCond);
    ...
    Accounts.find(matchCondition).then(results => {
        ...
        // console.log("First results MAtch Condition >>>", matchCondition);
        ...
        // console.log("second results opening balance >>>", vopbal);
        ...
        if(req.query.start_date) {
            ...
            // console.log("Third results if start date calculate opening balance using old records>>>>>>");
            ...
            calculateOpeningBalanceUsingOldRecords(rvopbal,accountType, function (err, newOpeningBalance) {
                ...
                // console.log("Opening Balance Results>>>>>>");
