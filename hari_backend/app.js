...
var type_master = require('./routes/admin-privileges/type-master');
...
var department_master = require('./routes/inventory/department-master');
...
app.use('/api/admin-privileges/type-master', type_master);
...
app.use('/api/inventory/department-master', department_master);
