...
const routes: Routes = [
  {
    ...
    children: [
      ...
      // Accounts - Master
      {path: 'accounts-master', component: ListAccountsMasterComponent},
      {path: 'accounts-master/:id/edit', component: EditAccountsMasterComponent,  resolve: { am_details: AccountsmasterReslover }},
      {path: 'add-accounts-master', component: AddAccountsMasterComponent},

      // Accounts - Category
      {path: 'accounts-category', component: ListAccountsCategoryComponent},
      {path: 'accounts-category/:id/edit', component: EditAccountsCategoryComponent,  resolve: { ac_details: AccountscategoryReslover }},
      {path: 'add-accounts-category', component: AddAccountsCategoryComponent},
