...
@Component({
  ...
  templateUrl: './scrap-ledger-report.component.html',
  styleUrls: ['./scrap-ledger-report.component.scss']
})
export class ScrapLedgerReportComponent implements OnInit {
...
fetchReport() {
    ...
    this.reportService.getScrapReports(this.filters).subscribe((res: any) => {
        this.loading = false;
        this.loaded = true;
