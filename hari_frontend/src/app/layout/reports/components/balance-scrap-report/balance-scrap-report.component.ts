...
@Component({
  ...
  templateUrl: './balance-scrap-report.component.html',
  styleUrls: ['./balance-scrap-report.component.scss'],
  animations: [routerTransition()]
})
export class BalanceScrapReportComponent implements OnInit {
  ...
  fetchReport() {
      ...
      this.loaded = false;
      this.monthlyData = [];
      this.inventoryService.getBalanceScrapStock(this.filters).subscribe((res: any) => {
          this.loading = false;
          this.loaded = true;
