...
@Component({
  ...
  templateUrl: './items-ledger-report.component.html',
  styleUrls: ['./items-ledger-report.component.scss'],
  animations: [routerTransition()]
})
export class ItemsLedgerReportComponent implements OnInit {
...
getSites() {
  ...
  fetchReport() {
      ...
      this.reportService.getItemReports(this.filters).subscribe((res: any) => {
          this.loading = false;
          this.loaded = true;
